        ...
        <div className="col-span-1 xl:row-span-4">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I&apos;m based in British Columbia, Canada and open to remote
                work worldwide.
              </p>
        ...
        <div className="xl:col-span-2 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                Coding lets me tackle challenges and bring ideas to life. I
                enjoy learning new technologies, refining my skills, and
